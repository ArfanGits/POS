            ...
            <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                    <li class="tab-element active">
                        <a href="#tab01_1st" class="tab-link"><span class="biolife-icon icon-grape2"></span><?php echo $array_collum['0']; ?></a>
                    </li>
                    <li class="tab-element">
                        <a href="#tab01_2nd" class="tab-link"><span class="biolife-icon icon-lemon"></span></span><?php echo $array_collum['1']; ?></a>
                    </li>
                    <li class="tab-element">
                            ...
                            <li class="product-item">
                                <div class="contain-product layout-default">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="price ">
                                            <ins><span class="price-amount"><?php echo $eight_pdt_ctg_one['pdt_price'] ?><span class="currencySymbol"> CAD$ </span></span></ins>
