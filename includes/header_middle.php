        ...
        <div class="row">
            <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                <a href="index.php" class="biolife-logo">
                    ...
                    <img src="assets/images/logo.png" alt="biolife logo" width="135" height="36">
            ...
            <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                <div class="primary-menu">
                    <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                        ...
                        ?>
                            <li class="menu-item"><a href="exit_order.php">Dashboard </a></li>
                        <?php
                        }
                        ?>
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        ...
                                                        <div class="left-info">
                                                            ...
                                                            <div class="price">
                                                                <ins><span class="price-amount"><?php echo $value['pdt_price'] ?><span class="currencySymbol"> CAD$</span></span></ins>
